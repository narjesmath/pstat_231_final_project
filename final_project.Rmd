...
identified 18/30 Normal-type, for example. From the heat map, we can see
that the model doesn't seem to be able to distinguish Water-type well at
all; it misclassifies other types as Water frequently, especially Grass.

The model is worst at differentiating; here, the model is worst at
identifying Grass- and Water-type, based on the ROC curves. They should
also identify those it's best at; here that appears to be Psychic- and
Normal-type.
