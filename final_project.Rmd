...
Error in prcomp.default(.) : cannot rescale a constant/zero column to
unit variance

The PCA analysis indicates that PC1 & PC2 represents a good amount of the data compare to teh rest.
